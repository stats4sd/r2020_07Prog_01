...
This works because for R, a dataframe is a list of columns. So `i in storms` will sequentially make i become each column of the dataframe storms. The function `is.numeric` will then check if the column is of type numeric and return either TRUE or FALSE, hence the output.
